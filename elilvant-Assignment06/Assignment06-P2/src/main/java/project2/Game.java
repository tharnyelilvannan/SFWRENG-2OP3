...
public class Game {
   ...
   } // end of humanVsHuman method

     // plays a human vs. human game with an NxN grid
     private void humanVsHuman(int N, int M) {
   ...
   // plays a human vs. computer game
    ...
    } // end of humanVsComputer method

   // plays a human vs. computer game
   private void humanVsComputer(int N, int M) {
   ...
   // plays a computer vs. computer game
    ...
    } // end of computerVsComputer method

   // plays a computer vs. computer game with an NxN grid
   private void computerVsComputer(int N, int M) {
